...
window.addEventListener('DOMContentLoaded', event => {
    ...
    // Cerrar barra de navegación receptiva cuando el conmutador es visible
    ...
    // Activar plugin SimpleLightbox para elementos del portafolio
    new SimpleLightbox({
        elements: '#portfolio a.portfolio-box:not(.external-link)'
    });
});
